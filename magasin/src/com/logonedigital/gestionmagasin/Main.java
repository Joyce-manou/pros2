...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        magasin.ajouter(produit1);
        magasin.ajouter(produit2);
        magasin.ajouter(produit3);

        magasin.afficher();
        magasin.afficherProduitsNomEtPrix();
        System.out.println("Le magasin contient " + magasin.getNombreTotalProduits() + " produits.");
